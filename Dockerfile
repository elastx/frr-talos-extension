FROM quay.io/frrouting/frr:9.0.5 as base
#RUN echo -e '\
#export ASN_METALLB_LOCAL=4200099998 \n\
#export ASN_METALLB_REMOTE=4200099999 \n\
#export NAMESPACE_METALLB=metallb \n\
#export PEER_IP_LOCAL=192.168.250.253 \n\
#export PEER_IP_REMOTE=192.168.250.254 \n\
#export PEER_IP_PREFIX=30 \n\
